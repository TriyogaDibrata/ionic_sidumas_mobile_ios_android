...
var TabsPage = /** @class */ (function () {
    function TabsPage(sharedService, platform, router, alertService) {
    ...
    TabsPage.prototype.getUser = function () {
        var _this = this;
        this.sharedService.getUser()
            .subscribe(function (data) {
            _this.user_type = data['tipe'];
        });
    };
                ...
                children: [
                    {
                        ...
                        loadChildren: function () {
                            return Promise.all(/*! import() | home-home-module */[__webpack_require__.e("default~home-home-module~notifications-notifications-module~pages-detail-laporan-detail-laporan-modu~75dc6b66"), __webpack_require__.e("home-home-module")]).then(__webpack_require__.bind(null, /*! ../home/home.module */ "./src/app/pages/home/home.module.ts")).then(function (m) { return m.HomePageModule; });
                        }
                    }
                ]
            },
                ...
                children: [
                    {
                        path: '',
                        loadChildren: function () {
                            return Promise.all(/*! import() | search-search-module */[__webpack_require__.e("default~home-home-module~notifications-notifications-module~pages-detail-laporan-detail-laporan-modu~75dc6b66"), __webpack_require__.e("search-search-module")]).then(__webpack_require__.bind(null, /*! ../search/search.module */ "./src/app/pages/search/search.module.ts")).then(function (m) { return m.SearchPageModule; });
                        },
                ...
                children: [
                    {
                        path: '',
                        loadChildren: function () {
                            return __webpack_require__.e(/*! import() | lapor-kategori-lapor-kategori-module */ "lapor-kategori-lapor-kategori-module").then(__webpack_require__.bind(null, /*! ../lapor-kategori/lapor-kategori.module */ "./src/app/pages/lapor-kategori/lapor-kategori.module.ts")).then(function (m) { return m.LaporKategoriPageModule; });
                        },
                        runGuardsAndResolvers: "always",
                        canActivate: [src_app_guards_auth_auth_guard__WEBPACK_IMPORTED_MODULE_4__["AuthGuard"]]
                    }
                ...
                children: [
                    {
                        path: '',
                        loadChildren: function () {
                            return Promise.all(/*! import() | notifications-notifications-module */[__webpack_require__.e("default~home-home-module~notifications-notifications-module~pages-detail-laporan-detail-laporan-modu~75dc6b66"), __webpack_require__.e("notifications-notifications-module")]).then(__webpack_require__.bind(null, /*! ../notifications/notifications.module */ "./src/app/pages/notifications/notifications.module.ts")).then(function (m) { return m.NotificationsPageModule; });
                        },
                        runGuardsAndResolvers: "always",
                        canActivate: [src_app_guards_auth_auth_guard__WEBPACK_IMPORTED_MODULE_4__["AuthGuard"]]
                    }
                ...
                children: [
                    {
                        path: '',
                        loadChildren: function () {
                            return __webpack_require__.e(/*! import() | profile-profile-module */ "profile-profile-module").then(__webpack_require__.bind(null, /*! ../profile/profile.module */ "./src/app/pages/profile/profile.module.ts")).then(function (m) { return m.ProfilePageModule; });
                        },
                        runGuardsAndResolvers: "always",
                        canActivate: [src_app_guards_auth_auth_guard__WEBPACK_IMPORTED_MODULE_4__["AuthGuard"]]
                    }
                ...
                children: [
                    {
                        path: '',
                        loadChildren: function () {
                            return __webpack_require__.e(/*! import() | project-project-module */ "project-project-module").then(__webpack_require__.bind(null, /*! ../project/project.module */ "./src/app/pages/project/project.module.ts")).then(function (m) { return m.ProjectPageModule; });
                        },
                        runGuardsAndResolvers: "always",
                        canActivate: [src_app_guards_auth_auth_guard__WEBPACK_IMPORTED_MODULE_4__["AuthGuard"]]
                    }
