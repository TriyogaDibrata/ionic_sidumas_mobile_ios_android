...
var DetailProjectPage = /** @class */ (function () {
    function DetailProjectPage(sharedService, route, navCtrl) {
        this.sharedService = sharedService;
        this.route = route;
        this.navCtrl = navCtrl;
    }
    DetailProjectPage.prototype.ngOnInit = function () {
    ...
    DetailProjectPage.prototype.getUser = function () {
        this.user = this.sharedService.getUserCache();
    };
    DetailProjectPage.prototype.getDetailProject = function () {
        var _this = this;
...
//# sourceMappingURL=pages-detail-project-detail-project-module-es5.js.map