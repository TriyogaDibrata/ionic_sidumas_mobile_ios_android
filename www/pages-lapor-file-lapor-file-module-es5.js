...
var LaporFilePageModule = /** @class */ (function () {
    function LaporFilePageModule() {
    }
...
var LaporFilePage = /** @class */ (function () {
    function LaporFilePage(commonService, cameraPreview, navCtrl, alertCtrl, camera, route, router, alertService) {
    ...
    LaporFilePage.prototype.ionViewWillEnter = function () {
        this.openCamera();
    };
    LaporFilePage.prototype.ngOnInit = function () {
        this.dataRec = this.route.snapshot.paramMap.get('dataObj');
        this.photos = [];
    };
    LaporFilePage.prototype.ngOnDestroy = function () {
        //Called once, before the instance is destroyed.
        //Add 'implements OnDestroy' to the class.
        this.cameraPreview.stopCamera();
    };
    LaporFilePage.prototype.ionViewWillLeave = function () {
        this.cameraPreview.stopCamera();
    };
    LaporFilePage.prototype.goTo = function (page) {
        this.commonService.goTo(page);
    };
    LaporFilePage.prototype.goForward = function (page) {
        this.commonService.goForward(page);
    };
    LaporFilePage.prototype.goBack = function (page) {
        this.commonService.goForward(page);
    };
    LaporFilePage.prototype.back = function () {
        this.navCtrl.back();
    };
    LaporFilePage.prototype.openCamera = function () {
    ...
    // take a picture
    LaporFilePage.prototype.takePicture = function () {
        var _this = this;
    ...
    LaporFilePage.prototype.deletePhoto = function (index) {
    ...
    LaporFilePage.prototype.openGallery = function () {
        var _this = this;
        var options = {
            quality: 100,
            targetHeight: 600,
    ...
    LaporFilePage.prototype.toTinjau = function () {
        var combineObj = {
            'data': this.dataRec,
            'files': this.photos,
        };
        var dataString = JSON.stringify(combineObj);
        this.navCtrl.navigateForward(['lapor-tinjau', dataString]);
    };
    LaporFilePage.prototype.switchCamera = function () {
        this.cameraPreview.switchCamera();
    };
    LaporFilePage.prototype.switchFlashOn = function () {
        this.flash_on = true;
        this.cameraPreview.setFlashMode(this.cameraPreview.FLASH_MODE.ON);
    };
    LaporFilePage.prototype.switchFlashOff = function () {
        this.flash_on = false;
        this.cameraPreview.setFlashMode(this.cameraPreview.FLASH_MODE.OFF);
    };
    LaporFilePage.ctorParameters = function () { return [
...
//# sourceMappingURL=pages-lapor-file-lapor-file-module-es5.js.map