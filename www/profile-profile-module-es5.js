...
var ProfilePage = /** @class */ (function () {
    ...
    ProfilePage.prototype.presentAlertConfirm = function (sm_type) {
    ...
    ProfilePage.prototype.logout = function (sm_type) {
        var _this = this;
        if (!sm_type) {
            ...
            this.authService.doFbLogout().then(function () {
