...
var LokasiPage = /** @class */ (function () {
    function LokasiPage(route, nativeGeocoder, alertService) {
        this.route = route;
        this.nativeGeocoder = nativeGeocoder;
        this.alertService = alertService;
    }
    LokasiPage.prototype.ngOnInit = function () {
    ...
    LokasiPage.prototype.geocoder = function (lat, lng) {
        var _this = this;
        var options = {
            useLocale: true,
            maxResults: 5
    ...
    LokasiPage.prototype.generateAddress = function (addressObj) {
        var obj = [];
        var address = "";
    ...
    LokasiPage.prototype.initMap = function () {
        var mapOptions = {
            camera: {
                target: {
                    lat: this.lat,
    ...
    LokasiPage.ctorParameters = function () { return [
...
//# sourceMappingURL=pages-lokasi-lokasi-module-es5.js.map