...
let DetailLaporanPage = class DetailLaporanPage {
    constructor(route, router, sharedService, alertService, navCtrl, socialSharing, loadingCtrl, commonService, formBuilder, alertCtrl, clipboard, popoverCtrl) {
        this.route = route;
        this.router = router;
    ...
    presentAlertMultipleButtons(user_id, data) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            let buttons;
...
DetailLaporanPage.ctorParameters = () => [
...
//# sourceMappingURL=pages-detail-laporan-detail-laporan-module-es2015.js.map