...
let ProfilePage = class ProfilePage {
    constructor(commonService, authService, sharedService, navCtrl, alertCtrl, loadingCtrl, camera, crop, actionSheetCtrl, alertService, http, env, modalCtrl, appRate, popover) {
