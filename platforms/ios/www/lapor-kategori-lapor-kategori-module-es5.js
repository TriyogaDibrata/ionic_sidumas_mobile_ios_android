...
var LaporKategoriPageModule = /** @class */ (function () {
    function LaporKategoriPageModule() {
    }
    ...
    return LaporKategoriPageModule;
}());
...
var LaporKategoriPage = /** @class */ (function () {
    function LaporKategoriPage(navCtrl, router, route, sharedService, authService, loadingCtrl, alertService, callNumber) {
    ...
    LaporKategoriPage.prototype.ngOnInit = function () {
    };
    LaporKategoriPage.prototype.ionViewWillEnter = function () {
        this.checkUser();
        this.getKategori();
    };
    LaporKategoriPage.prototype.showLoading = function () {
    ...
    LaporKategoriPage.prototype.goToLapor = function (id, event) {
        var _this = this;
        if (event) {
            var event_detail = event.split(',');
            if (event_detail[0] == 'call_number') {
                this.callNumber.callNumber(event_detail[1], true)
                    .then(function (res) { return console.log('Launched Dialer', res); })
                    .catch(function (err) { return _this.alertService.presentAlert('Terjadi Kesalahan', err); });
            }
    ...
    LaporKategoriPage.prototype.getKategori = function () {
        var _this = this;
    ...
    LaporKategoriPage.prototype.checkUser = function () {
        var _this = this;
        ...
        this.sharedService.checkUser(this.user['id'])
            ...
            if (!data['success']) {
                ...
                return _this.allowed_user = false;
            }
            else {
                _this.loading.dismiss();
                return _this.allowed_user = true;
            }
        });
    };
    LaporKategoriPage.ctorParameters = function () { return [
...
//# sourceMappingURL=lapor-kategori-lapor-kategori-module-es5.js.map