...
var SearchPage = /** @class */ (function () {
    function SearchPage(sharedService, alertService, commonService, loadingCtrl) {
    ...
    SearchPage.prototype.getUser = function () {
        var _this = this;
        this.sharedService.getUser()
            .subscribe(function (data) {
            _this.user = data;
            _this.getMyList(_this.user['id']);
        }, function (err) {
            _this.commonService.presentAlert('Gagal memuat', 'Terjadi kesalahan saat memuat data');
        });
    };
    SearchPage.prototype.getMyList = function (user_id) {
        var _this = this;
    ...
    SearchPage.prototype.doRefresh = function (event) {
        var _this = this;
        this.showLoading();
        this.iScroll.page = 0;
        this.iScroll.enable = 1;
    ...
    SearchPage.prototype.converTime = function (time) {
    ...
    SearchPage.prototype.nextPage = function (event) {
        var _this = this;
    ...
    SearchPage.prototype.transformData = function (rows) {
        var _this = this;
        rows.forEach(function (data) {
            _this.lists.push(data);
        });
    };
    SearchPage.prototype.showLoading = function () {
    ...
    SearchPage.prototype.voteColor = function (islike) {
        if (islike == null) {
            return "";
        }
        else {
    ...
    SearchPage.prototype.addVote = function (pengaduan) {
        var _this = this;
        var data = {
    ...
    SearchPage.prototype.seeDetail = function (pengaduan) {
