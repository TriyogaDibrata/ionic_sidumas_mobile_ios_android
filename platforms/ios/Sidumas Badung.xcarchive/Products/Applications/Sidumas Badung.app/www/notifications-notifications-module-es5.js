...
var NotificationsPage = /** @class */ (function () {
    function NotificationsPage(sharedService, commonService, loadingCtrl, alertCtrl, alertService) {
    ...
    NotificationsPage.prototype.firstNotifs = function (id) {
        var _this = this;
        this.sharedService.getNotifs(id, this.page, 1)
            ...
            _this.sharedService.notif.news = 0;
    ...
    NotificationsPage.prototype.nextPage = function (event) {
        var _this = this;
    ...
    NotificationsPage.prototype.transformData = function (rows) {
        var _this = this;
        moment__WEBPACK_IMPORTED_MODULE_5__["locale"]('id');
        rows.forEach(function (data) {
            var date = moment__WEBPACK_IMPORTED_MODULE_5__(data.created_at, 'YYYY-MM-DD HH:mm:ss');
            data.mmmmyy = date.format('MMMM YY');
            data.ddmmm = date.format('DD MMM');
            data.group = 0;
            if (_this.lastMonth != date.month()) {
                data.group = 1;
                _this.lastMonth = date.month();
            }
            data.title = _this.capitalizeFirstLetter(data.title);
            _this.notifs.push(data);
        });
    };
    NotificationsPage.prototype.capitalizeFirstLetter = function (string) {
        return string.charAt(0).toUpperCase() + string.slice(1);
    };
    NotificationsPage.prototype.getUser = function () {
    ...
    NotificationsPage.prototype.redirectTo = function (page) {
        if (page != null) {
